        ...
        AppOpenAd.load(
            ...
            object : AppOpenAd.AppOpenAdLoadCallback() {
                override fun onAdLoaded(ad: AppOpenAd) {
                    ...
                    appOpenAd = ad
                    if (Adx) {
                        logD(TAG, "MEDIUM_RECTANGLE onAdLoaded: AppOpen_LANDSCAPE ->ADX ")
                    } else {
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    ...
                    if (Adx) {
                        logD(
                            TAG,
                            "MEDIUM_RECTANGLE onAdFailedToLoad: AppOpen_LANDSCAPE ->ADX ${loadAdError}"
                        )
                    } else {
                        logD(
                            TAG,
                            "MEDIUM_RECTANGLE onAdFailedToLoad: AppOpen_LANDSCAPE ->AdMob ${loadAdError}"
                        )
                    }
                }
            }
